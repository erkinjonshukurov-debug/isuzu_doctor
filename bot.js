...
// -------------------- TOKEN VA ADMIN --------------------
// TOKENNI O'ZINGIZNING BOT TOKENINGIZGA O'ZGARTIRING
const BOT_TOKEN = '8779251766:AAH12INusgBCawsk5awqIjcyHnNLiq5A33A';

const ADMIN_PHONE = "+998979247888";
const ADMIN_IDS = [1437230485]; // Admin Telegram ID si
...
console.log('='.repeat(60));
console.log('✅ Bot ishlashga tayyor!');const TelegramBot = require('node-telegram-bot-api');
const path = require('path');
const fs = require('fs');
const sqlite3 = require('sqlite3').verbose();
